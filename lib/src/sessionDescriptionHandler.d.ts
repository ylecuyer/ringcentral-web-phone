import type { BodyAndContentType, Session, SessionDescriptionHandler as SessionDescriptionHandlerDefinition, SessionDescriptionHandlerModifier } from 'sip.js';
...
export declare class SessionDescriptionHandler implements SessionDescriptionHandlerDefinition {
     ...
     */
    constructor(logger: Logger, mediaStreamFactory: MediaStreamFactory, sessionDescriptionHandlerConfiguration?: WebPhoneSessionDescriptionHandlerConfiguration);
    /**
